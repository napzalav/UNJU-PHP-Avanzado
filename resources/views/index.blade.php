...
<head>
    ...
    <style>
        ...
        footer{min-height: 5vh;background-color: rgb(0, 3, 60);color: aliceblue;display: flex;justify-content: center;text-align: center;}
    </style>
</head>
<body>
    <header>
...
{{-- aqui empieza un modelo de Card con Bootstrap--}}
                    {{-- <div class="card" style="width: 100%;">
                        <img src="fo4.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h2 class="card-title mt-6 text-xl font-semibold text-gray-900 dark:text-black">Noticia</h2>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque dolorem tenetur quaerat ab reiciendis sapiente, sed sit ex quam laborum sunt ducimus voluptatibus deleniti molestiae reprehenderit repellendus in eius dolores.</p>
                            <p class="card-text mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">Fecha de publicación:</p>
                            <a href="#" class="btn btn-primary">Ver detalles</a>
                        </div>
                    </div> --}}
{{-- fin Card bootstrap--}}

{{-- este es una card de ejemplo con Laravel --}}
                    {{-- <div class="mt-16">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            <a href="#" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                                <div>
                                    <img src="fo4.jpg" alt="">
                                    <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-black">Noticias</h2>

                                    <p class="mt-4 text-gray-500 dark:text-black-400 text-sm leading-relaxed">
                                        Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias. Estas son todas las noticias.
                                    </p>
